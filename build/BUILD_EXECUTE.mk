...
CPP_OBJECT_MIDDLE       := $(APP_ROOT)/im_qnx_$(PROJECT_NAME)/$(APP_NAME)/$(TARGET_MODULE)/Release
...
$(RELEASE_TARGET): $(CPP_APP_OBJECT) $(C_APP_OBJECT)
	...
	@pwd
	@$(COPY) $(COPY_LIBRARIES_THIRD) $(CPP_TARGETDIR)/
...
$(DEBUG_TARGET): $(CPP_APP_OBJECT_DEBUG) $(C_APP_OBJECT_DEBUG)
	...
	@$(COPY) $(COPY_LIBRARIES_THIRD) $(CPP_TARGETDIR_DEBUG)/
