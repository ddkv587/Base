...
CPP_TARGETDIR           := $(TARGET_ROOT)/qnx/$(PROJECT_NAME)/Release
CPP_TARGETDIR_DEBUG     := $(TARGET_ROOT)/qnx/$(PROJECT_NAME)/Debug
CPP_OBJECT_MIDDLE       := $(IM_ROOT_PREX)qnx_$(PROJECT_NAME)/$(TARGET_MODULE)/Release
CPP_OBJECT_MIDDLE_DEBUG := $(IM_ROOT_PREX)qnx_$(PROJECT_NAME)/$(TARGET_MODULE)/Debug
